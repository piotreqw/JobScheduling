...
def test_simplified_complete_allocation(max_iterations=20, total_tasks_time=450 // 15) -> None:
...
def test_slack_for_min_employees_simplified_complete_allocation() -> None:
